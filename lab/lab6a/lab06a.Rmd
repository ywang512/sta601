...
$$
Y^{\left(A\right)}_i |Y^{\left(B\right)}_i, \boldsymbol \theta, \Sigma  \sim \text{Normal}\left(\theta_A + \frac{\rho \sigma_A}{\sigma_B}\left(Y^{\left(B\right)}_i - \theta_B\right), \sigma^2_A\left(1 - \rho\right)\right),
$$

and

$$
Y^{\left(B\right)}_i |Y^{\left(A\right)}_i, \boldsymbol \theta, \Sigma  \sim \text{Normal}\left(\theta_B + \frac{\rho \sigma_B}{\sigma_A}\left(Y^{\left(A\right)}_i - \theta_A\right), \sigma^2_B\left(1 - \rho\right)\right).
$$
